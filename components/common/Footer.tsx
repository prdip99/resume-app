...
export function Footer() {
  ...
  const navigation = {
    ...
    resources: [
      { name: 'Resume Guide', href: '/guides/resume' },
      { name: 'Cover Letter Guide', href: '/guides/cover-letter' },
      { name: 'Interview Tips', href: '/guides/interview' },
      { name: 'Career Advice', href: '/guides/career' },
    ],
    legal: [
      ...
      <div className="container mx-auto px-4 md:px-6 pt-16 pb-8">
          ...
          <div className="space-y-8 xl:col-span-1">
            <div>
              ...
              <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                Create beautiful, professional resumes in minutes that help you land your dream job.
              </p>
            </div>
        ...
        <div className="mt-12 border-t border-gray-200 dark:border-gray-800 pt-8">
          <p className="text-base text-gray-500 dark:text-gray-400 xl:text-center">
            &copy; {currentYear} ProResume, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
